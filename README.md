...
A [CNPG-I](https://github.com/cloudnative-pg/cnpg-i) plugin to simply skip
the "initdb" bootstrap method of CNPG.
...
[`release-please` workflow](https://github.com/leonardoce/cnpg-i-skip-initdb/actions/workflows/release-please.yml).
